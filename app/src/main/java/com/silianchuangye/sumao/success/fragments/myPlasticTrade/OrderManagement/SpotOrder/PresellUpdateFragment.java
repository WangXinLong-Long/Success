 ...
 */
public class PresellUpdateFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_presell_update, container, false);
        //实例化
...
//                startActivity(intent);
                Toast.makeText(getActivity(),"跳转已取消界面",Toast.LENGTH_SHORT).show();
                return true;
    ...
    public  void sendMy(String subType, String KPstate, String startDate, String endDate, final String company, String OrderId){
        ...
        params.addParameter("searchOrderState","REMOVED");
