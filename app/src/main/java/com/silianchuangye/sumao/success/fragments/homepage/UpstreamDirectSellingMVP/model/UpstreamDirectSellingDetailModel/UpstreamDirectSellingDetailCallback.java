 ...
 */
public interface UpstreamDirectSellingDetailCallback {
    void callbackIUpstreamDirectSellingDetail(VipProductBean vipProductBean,String sellerCompanyId,String title);
}
