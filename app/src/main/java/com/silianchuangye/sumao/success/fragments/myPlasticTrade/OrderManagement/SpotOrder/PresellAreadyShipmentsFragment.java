 ...
 */
public class PresellAreadyShipmentsFragment extends Fragment {
    ...
    public PresellAreadyShipmentsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_presell_aready_shipments, container, false);
        //实例化
...
//                startActivity(intent);
                Toast.makeText(getActivity(),"跳转已发货界面",Toast.LENGTH_SHORT).show();
                return true;
