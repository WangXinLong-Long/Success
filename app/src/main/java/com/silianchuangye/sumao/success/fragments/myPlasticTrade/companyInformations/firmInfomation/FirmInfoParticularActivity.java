...
public class FirmInfoParticularActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_firm_info_particular);
        title_Bar();
    }
    public void title_Bar() {
        ...
        tv_title_bar_title.setText("详细地址");
        tv_title_bar_title.setTextColor(Color.WHITE);
        iv_title_bar_back.setVisibility(View.VISIBLE);
        layoutTop = (RelativeLayout) findViewById(R.id.layoutTop_firm_info_particular);
        ...
        iv_title_bar_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FirmInfoParticularActivity.this.finish();
            }
        });
    }
}
